...
## Salvar o resultado
df_demography.to_csv("processing/global_indicators/entities_global_csv/Demography.csv", index=False)
...
# Salvar o CSV
df_life_expectancy.to_csv("processing/global_indicators/entities_global_csv/Life_expectancy2.csv", index=False)
...
# Salvar o CSV
df_population.to_csv("processing/global_indicators/entities_global_csv/Population.csv", index=False)
...
## Salvar o resultado
df_employment.to_csv("processing/global_indicators/entities_global_csv/Employment.csv", index=False)
...
## Salvar o resultado
df_education.to_csv("processing/global_indicators/entities_global_csv/Education.csv", index=False)
...
## Salvar o resultado
df_health.to_csv("processing/global_indicators/entities_global_csv/Health.csv", index=False)
...
## Salvar o resultado
df_economy.to_csv("processing/global_indicators/entities_global_csv/Economy.csv", index=False)
